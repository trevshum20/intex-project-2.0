...
from .views import doctorPrescriberPageView, deletePrescriberPageView, mlPageView, mlResult, recResult, rec, recExample
urlpatterns = [
    ...
    path('recexample/<int:prescriber_id>/<str:fname>/<str:lname>/', recExample, name="recexample"),
